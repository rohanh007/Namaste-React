  ...
  return (
    <div className="food-card">
      <div className="restaurant-card">
        ...
        <div class="sc-kpDqfm bhUeB sc-cwHptR jRWNeE">
          <div class="sc-aXZVg eOcpsq sc-dAlyuH jzlukq"></div>
          <div class="sc-aXZVg ivxbaH sc-dAlyuH jzlukq"> {`${aggregatedDiscountInfoV3?.header || ''} ${aggregatedDiscountInfoV3?.subHeader || ''}`}</div>
          <div class="sc-aXZVg dMioqQ sc-dAlyuH jzlukq"></div>
        </div>
      </div>
      ...
      <div style={{ marginLeft: '12px' }}>
        ...
        <div className="sw-restaurant-card-subtext-container">
          ...
          <div className="sc-aXZVg bUjCLt" style={{ marginTop: '-4px' }}>
            <span className="sc-aXZVg gnOsqr">{avgRating}• </span>{sla.slaString}
          </div>
        </div>
        <div className="sw-restaurant-card-descriptions-container">
          <div className="sc-aXZVg dnXOKm">{cuisines.join(", ")}</div>
          <div className="sc-aXZVg dnXOKm">{locality}</div>
        </div>
      </div>

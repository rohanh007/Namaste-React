const Restheader =()=>{
    ...
    <div class="HeaderWrapper MarginBottom">
        <div class="NameAddressWrapper">
            <div aria-hidden="true">
                <p class="NameAddressName">Chaayos Chai+Snacks=Relax</p>
                <p class="NameAddressCuisines">Bakery, Beverages</p>
            </div>
            <div class="AreaWrapper" aria-label="">
                <p class="Area" aria-hidden="true">Hinjawadi</p>
                <p class="LastMile" aria-hidden="true">4.5 km</p>
                <div class="OutletSelectorWrapper">
                    <button class="OutletSelector" aria-label="Selected outlet is Hinjawadi, 4.5 km away. Double tap to change outlet.">
                        <span class="OutletIcon">▾</span>
                    </button>
                </div>
            </div>
        </div>
        <button class="RatingsWrapper" data-testid="restaurant-ratings-header" aria-hidden="true">
            <span class="AvgRating" aria-hidden="true">
                <span class="icon-star"></span> <span>4.4</span>
            </span>
            <span class="TotalRatings" aria-hidden="true">1K+ ratings</span>
        </button>
    </div>
    <ul>
        <li class="MessageWrapper">
            ...
            <span class="MessageText" aria-hidden="true">Far (4.5 kms) | Additional delivery fee will apply</span>
            <span class="ScreenReaderOnly" tabindex="0">Far (4.5 kms) | Additional delivery fee will apply</span>
        </li>
    </ul>
    {/* <hr class="DottedSeparator MarginBottom" aria-hidden="true"> */}
    <div class="MarginBottom" aria-hidden="true">
        <ul class="TimeCostWrapper">
